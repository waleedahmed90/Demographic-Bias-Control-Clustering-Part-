...
path_gender = "./Demographics_Percentages/Gender_Percentage_User_Demographics.gz"
path_race = "./Demographics_Percentages/Race_Percentage_User_Demographics.gz"
path_age = "./Demographics_Percentages/Age_Percentage_User_Demographics.gz"
